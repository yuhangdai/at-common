...
public class GlobalParams {
	 ...
	 * crm 用户合并状态key。
	 */
	public static final String CRM_CU_MERGE_STATUS_REDIS_KEY="crm_cu_merge_status_redis_key";

	public static final String CRM_CU_MERGE_STATUS_REDIS_IDNUMBER_KEY="crm_cu_merge_status_redis_idNumber_key";
}
